<?php namespace Dmitrybykov\Graphqltest;
...
return [
    ...
    'schemas' => [
        'default' => [
            // 'query' => [
            //     'tests' => GraphQL\Query\TestsQuery::class,
            //     'users' => GraphQL\Query\UsersQuery::class,
            // ],
            // 'mutation' => [
            //     'createUser' => GraphQL\Mutation\CreateUserMutation::class
            // ]
        ]
    ],
    ...
    'types' => [
    //    'test' => GraphQL\Type\TestType::class,
    //    'User' => GraphQL\Type\UserType::class
    ],
